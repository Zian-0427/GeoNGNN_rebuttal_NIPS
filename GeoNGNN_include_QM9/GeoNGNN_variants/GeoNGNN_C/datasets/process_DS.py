...
raw_path = f"{args.data_dir}/raw/ds/"
processed_path = f"{args.data_dir}/processed/ds/"
...
train_dataset = "train_small_enantiomers_stable_full_screen_docking_MOL_margin3_234622_48384_24192.pkl"
val_dataset = "validation_small_enantiomers_stable_full_screen_docking_MOL_margin3_49878_10368_5184.pkl"
test_dataset = "test_small_enantiomers_stable_full_screen_docking_MOL_margin3_50571_10368_5184.pkl"
...
for _, path in enumerate([train_path, val_path, test_path]):
    with open(path, 'rb') as fl:
        ...
        for i in tqdm(range(n), "processing " + split_name[_] + " split"):
            line = data.iloc[i]
            mol = getMol(line['SMILES_nostereo'], line['ID'], line['rdkit_mol_cistrans_stereo'], line['top_score'])
            full_dataset.append(mol)
import os
if os.path.exists(processed_path) == False:
    os.makedirs(processed_path)
torch.save(full_dataset, processed_path + "ds_full.pt")
