...
from lightningModule.basic_procedures import basic_train_callback
...
def trainer_setup(
    ...
    earlystopping = EarlyStopping(monitor=monitor, patience=early_stopping_patience, mode="max")
    modelcheckpoint = ModelCheckpoint(monitor=monitor, filename="{epoch}-{step}", mode="max")
