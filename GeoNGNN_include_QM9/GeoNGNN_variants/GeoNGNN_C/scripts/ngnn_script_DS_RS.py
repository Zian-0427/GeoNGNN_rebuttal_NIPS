...
from datasets.DS import DS_datawork
from datasets.RS import RS_datawork
from lightningModule.DS_module import DS_module
from lightningModule.RS_module import RS_module
...
parser.add_argument("--model", choices=["GeoNGNN_C"], default="GeoNGNN_C")
parser.add_argument("--ds", choices=["DockingScore", "RS"], default="DockingScore")
parser.add_argument("--dname", default="None")
...
model_config.train_e_loss_fn = "l1"
model_config.train_f_loss_fn = "rmse"
model_config.metric_fn_e = "l1"
model_config.metric_fn_f = "l1"
...
datawork = RS_datawork if dataset_name == "RS" else DS_datawork
module = RS_module if dataset_name == "RS" else DS_module
...
if (skip_train or resume) and checkpoint_path is not None:
    module_instance = module.load_from_checkpoint(
